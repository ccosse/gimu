...
class SignupView(FormView):
    ...
    def after_signup(self, form):
        #Added by Charles Cosse (ccosse@gmail.com)
        x=geonode.people.models.Profile.objects.get(username=self.created_user.username)
        x.organization=form.cleaned_data.get("organization")
        x.position=form.cleaned_data.get("position")
        x.save()
